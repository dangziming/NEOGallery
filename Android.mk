...
LOCAL_PACKAGE_NAME := NEOGallery

LOCAL_PRIVILEGED_MODULE := true

LOCAL_OVERRIDES_PACKAGES := Gallery Gallery3D GalleryNew3D Gallery2 MtkGallery2

LOCAL_SDK_VERSION := current

LOCAL_JNI_SHARED_LIBRARIES := libjni_gallery_eglfence libjni_gallery_filters 

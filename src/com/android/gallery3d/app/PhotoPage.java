...
//            }
    ...
    protected void onBackPressed() {
        ...
        mActivity.getToolbar().setOverflowIcon(mActivity.getAndroidContext().getResources().getDrawable(R.drawable.more));
        mActivity.getToolbar().setTitleTextAppearance(mActivity.getActionBar().getThemedContext(), R.style.ToolbarTitleStyle);
        GalleryActivity.tv_main_line.setVisibility(View.VISIBLE);
    }
...
//            }
    ...
    protected void onResume() {
        ...
        if (((mSecureAlbum == null) && (mSetPathString != null))) {
            ...
            mActivity.getToolbar().setNavigationIcon(R.drawable.photo_back);
            mActivity.getToolbar().setOverflowIcon(mActivity.getAndroidContext().getResources().getDrawable(R.drawable.more2));
            //mActivity.getActionBar().getThemedContext().setTheme(R.style.ToolbarPhotoTheme);
            mActivity.getToolbar().setTitleTextAppearance(mActivity.getActionBar().getThemedContext(), R.style.ToolbarTitlePhotoStyle);
            // mActivity.getToolbar().setTitleTextColor(R.color.toolbar_title_text_white);
        }
        ...
        mModel.resume();
        mPhotoView.resume();
        mActivity.getToolbar().setOverflowIcon(mActivity.getAndroidContext().getResources().getDrawable(R.drawable.more_def));
        GalleryActivity.tv_main_line.setVisibility(View.GONE);
    }
